        ...
        public async Task Stats()
        {
            ...
            await Context.Channel.EmbedAsync(
                new EmbedBuilder().WithOkColor()
                    .WithAuthor(eab => eab.WithName($"NadekoBot {StatsService.BotVersion}")
                                          .WithUrl("https://github.com/Raikerian/NadekoBot/tree/master")
                                          .WithIconUrl("https://cdn.discordapp.com/avatars/436922181147033600/e849847800d4a0530a8013405ad84b5e.png"))
